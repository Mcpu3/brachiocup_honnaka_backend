...
def read_item_thumbnail(database: Session, item_thumbnail_uuid: str) -> Optional[models.ItemThumbnail]:
    return database.query(models.ItemThumbnail).filter(models.ItemTHumbnail.uuid == item_thumbnail_uuid).first()
